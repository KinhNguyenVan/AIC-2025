...
mapping_topics = {
    "tin tức": ["K01","K02","K03","K04","K05","K06"], 
    "Tin tức+múa lân": ["L24","K07","K08","K09","K10","K11"],
    "Tin tức+xe đạp": ["L23","K12","K13","K14","K15","K16"],
    "Tin tức+dạy học online": ["L25","K17","K18","K19","K20","L21"],
    "Tin tức+chương trình nấu ăn": ["L26","L22","L27","L28","L29","L30"]
}
